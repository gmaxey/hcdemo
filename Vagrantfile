...
Vagrant.configure(2) do |config|
  ...
  # Vagrant assumes "vagrant" and it doesn't hurt to spell it out explicitly
  config.ssh.username = 'vagrant'
  config.ssh.password = "vagrant"
  # Vagrant automatically inserts a keypair when insert_key is true.
  config.ssh.insert_key = false
  # Enable forwarding over SSH connections.  False by default.
